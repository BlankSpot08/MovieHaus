...
import Logo from "../../assets/MovieHaus.png";
const Footer = () => {
  return (
    <footer className="bg-gray-50 text-gray-600 px-6 lg:px-8 py-12 mt-10 w-full ">
      <div className="max-w-screen-xl mx-auto ">
        <div className="grid grid-cols-8 md:grid-cols-9  lg:grid-cols-8  divide-gray-200 divide-y-2 md:divide-x-2 md:divide-y-0 md:-mx-8">
          <div className="col-span-8 md:col-span-3 lg:col-span-2 md:px-8 py-4 md:py-0">
            <h5 className="text-xl font-semibold text-gray-700">Movie Haus</h5>
            <nav className="mt-4">
              ...
              <ul className="grid lg:grid-cols-1">
                <li className="mb-2">
                  <a
                    ...
                    className="font-normal text-base hover:text-gray-400"
                  >
                    Unit 17/18 Century Plaza, Juana Osmena St. Cebu City
                  </a>
                </li>
                <li className="mb-2">
                  <a
      ...
      <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-4 mt-8 lg:mt-12 border-t-2 border-gray-200 pt-8">
        <p className="text-sm text-center md:text-right">
          &copy;2020 Movie Hause. All rights reserved. | All rights reserved
        </p>
      </div>
    </footer>
  );
