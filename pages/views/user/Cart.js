            ...
            <div className="flex-1">
              ...
              <div className="my-4 mt-6 ml-16 -mx-2 lg:flex">
                ...
                <div className="ml-16">
                  ...
                  <a href="#">
                    <button className="flex justify-center w-full px-10 py-2 mt-6 font-medium text-white uppercase bg-pink-400 rounded-full shadow item-center hover:bg-pink-500 focus:shadow-outline focus:outline-none">
